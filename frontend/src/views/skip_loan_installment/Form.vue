	...
	<ion-page>
		<ion-content :fullscreen="true">
			<FormView
				...
				doctype="Skip Loan Installment"
				v-model="skipLoanInstallment"
				:isSubmittable="true"
...
// 	getCompanyCurrency(skipLoanInstallment.value.company)
// )

// get form fields
const formFields = createResource({
	url: "hrms.api.get_doctype_fields",
	params: { doctype: "Skip Loan Installment" },
	transform(data) {
...
// 	onSuccess(data) {
// 		skipLoanInstallment.value.currency = data
// 		setExchangeRate()
// 	},
// })
...
// 	onSuccess(data) {
// 		skipLoanInstallment.value.exchange_rate = data
// 	},
// })

// const advanceAccount = createResource({
// 	url: "hrms.api.get_advance_account",
// 	params: { company: skipLoanInstallment.value.company },
// 	onSuccess(data) {
// 		skipLoanInstallment.value.advance_account = data
// 	},
// })

// form scripts
// watch(
// 	() => skipLoanInstallment.value.currency,
// 	() => setExchangeRate()
// )
...
// 			let currencies = [skipLoanInstallment.value.currency]
// 			if (skipLoanInstallment.value.currency != companyCurrency.value)
// 				currencies.push(companyCurrency.value)

// 			field.linkFilters = {
// 				company: skipLoanInstallment.value.company,
// 				is_group: 0,
// 				root_type: "Asset",
...
// 	if (!skipLoanInstallment.value.currency) return
// 	const exchange_rate_field = formFields.data?.find(
// 		(field) => field.fieldname === "exchange_rate"
// 	)

// 	if (skipLoanInstallment.value.currency === companyCurrency.value) {
// 		skipLoanInstallment.value.exchange_rate = 1
// 		exchange_rate_field.hidden = 1
// 	} else {
// 		exchangeRate.fetch({
// 			from_currency: skipLoanInstallment.value.currency,
